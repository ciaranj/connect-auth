...
exports.Facebook= AuthStrategy.extend({
   ...
   redirectUrl: function( redirectUrl ) {
     ...
     return parsedUrl.protocol + "//"+ parsedUrl.host+ "/auth/facebook_callback";
   },
   ...
   authenticate: function(request, callback) {     
     ...
     if( request.param("code") ) {
       this._oAuth.getOAuthAccessToken(request.param("code"), 
        ...
        var redirectUrl= this._oAuth.getAuthorizeUrl({redirect_uri : self.redirectUrl(request.back), scope: this.scope })
