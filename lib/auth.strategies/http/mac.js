...
bodyHashMode       - optional string, one of ['ignore', 'validate', 'require']. 'ignore' will not validate any
                     ...
                     will require any request other than GET / OPTIONS / HEAD, with or without an entity-body to
                     include a 'bodyhash' value, and validate the hash. Defaults to 'validate'. Requires
                     express.bodyDecoder() to set req.rawBody for any mode other than 'ignore'.
*/
...
Mac = module.exports = function (options) {
    ...
    that.authenticate = function (request, response, callback) {
        ...
        if (request.headers.authorization == null ||
            ...
            return replyUnauthorized(401, 'No authentication', response, callback, self);
        }
        ...
        if (credentials.type == null ||
            ...
            return replyUnauthorized(401, 'Incorrect authentication scheme', response, callback, self);
        }
        ...
        if (credentials.token == null ||
            ...
            return replyUnauthorized(400, 'Missing attributes', response, callback, self);
        }
        ...
        if (my._bodyHashMode == 'require' &&
            ...
            if (credentials.bodyhash == null ||
                ...
                return replyUnauthorized(400, 'Missing required body hash attribute', response, callback, self);
            }
        }
        ...
        if (hostHeader == null) {
            ...
            return replyUnauthorized(400, 'Missing Host header', response, callback, self);
        }
        ...
        if (hostParts == null ||
            ...
            return replyUnauthorized(400, 'Bad Host header', response, callback, self);
        }
        ...
        my._getTokenAttributes(credentials.token, function (tokenAttributes) {
            ...
            if (tokenAttributes == null ||
                ...
                return replyUnauthorized(401, 'Invalid token', response, callback, self);
            }
            ...
            if (credentials.bodyhash != null &&
                ...
                if (bodyHash != credentials.bodyhash) {
                    ...
                    return replyUnauthorized(401, 'Bad body hash', response, callback, self);
                }
            }
            ...
            if (signature != credentials.signature) {
                ...
                return replyUnauthorized(401, 'Bad signature', response, callback, self);
            }
            ...
            my._checkNonce(credentials.token, credentials.timestamp, credentials.nonce, function (isValid) {
                ...
                if (isValid == false) {
                    ...
                    return replyUnauthorized(401, 'Invalid nonce', response, callback, self);
                }
...
function replyUnauthorized(code, message, response, callback, executionScope) {

    response.writeHead(code, { 'Content-Type': 'text/plain',
        'WWW-Authenticate': 'MAC realm="' + my._realm + '"' + (message ? ',message="' + message + '"')
    });
